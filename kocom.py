...
room_h_dic = {'livingroom':'00', 'myhome':'00', 'room1':'01', 'room2':'02', 'room3':'03', 'room4':'04', 'room5':'05'}
    ...
    if dev == 'fan':
        ...
        for num in range(1, int(config.get('User', 'light_count'))+1):
            ...
            payload = {
                ...
                'pl_off': 'off',
                'qos': 0,
     #           'uniq_id': '{}_{}_{}{}'.format('kocom', 'wallpad', dev, num),          # 231204 주석처리
                 'uniq_id': '{}_{}_{}{}'.format('kocom', sub, dev, num),                # 231204 수정
                'device': {
                    'name': '코콤 스마트 월패드',
                    'ids': 'kocom_smart_wallpad',
                    'mf': 'KOCOM',
